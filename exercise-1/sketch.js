...
function setup() {
  ...
  function draw() {
    ...
    let waves = createImg("images/waves.png");
...
function realwaves(){
  let realwaves = createImg("images/realwaves.jpg");
  realwaves.size(400,400);
  realwaves.position(800,400);
}
